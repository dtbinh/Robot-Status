...
/**
 * An abstract class for a temperature sensor. This is any device that can return a temperature measurement.
 * A temperature sensor has a name and can provide a temperature value.
 */
public abstract class TemperatureSensor {
	...
	/**
	 * Get the temperature above which a warning message should be displayed/logged
	...
	/**
	 * If a message has been logged indicating that this sensor is at a warning temperature
	 * level.
	 * This is used by the {@link RobotMonitor} (it is package private).
	 */
